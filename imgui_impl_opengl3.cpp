...
bool    ImGui_ImplOpenGL3_CreateDeviceObjects()
{
    ...
    const GLchar* vertex_shader_glsl_120 =
        ...
        "    v_tex = UV;\n"
        "    v_color = Color;\n"
        "    v_position = mul(float4(Position.xy, 0, 1), ProjMtx);\n"
        "}\n";
    ...
    const GLchar* vertex_shader_glsl_130 =
        ...
        "    Frag_UV = UV;\n"
        "    Frag_Color = Color;\n"
        "    gl_Position = mul(ProjMtx, float4(Position.xy, 0, 1);\n"
        "}\n";
    ...
    const GLchar* fragment_shader_glsl_120 =
        ...
        "float2 v_tex : TEXCOORD0,\n"
        "float4 v_color : COLOR\n"
        ") : COLOR \n"
        "{\n"
        "    return v_color * tex2D(tex0, v_tex.xy);\n"
        "}\n";
    ...
    const GLchar* fragment_shader_glsl_130 =
        ...
        ")\n"
        "{\n"
        "    Frag_Color = Frag_Color * tex2D(Texture, Frag_UV.st);\n"
        "}\n";
    ...
    g_AttribLocationTex = glGetUniformLocation(g_ShaderHandle, "tex0");
