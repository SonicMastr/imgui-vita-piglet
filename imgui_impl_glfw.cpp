...
static void ImGui_ImplGlfw_UpdateGamepads()
{
    ...
    MAP_BUTTON(ImGuiNavInput_Activate,   GLFW_GAMEPAD_BUTTON_CROSS);     // Cross / A
    MAP_BUTTON(ImGuiNavInput_Cancel,     GLFW_GAMEPAD_BUTTON_CIRCLE);     // Circle / B
    MAP_BUTTON(ImGuiNavInput_Menu,       GLFW_GAMEPAD_BUTTON_SQUARE);     // Square / X
    MAP_BUTTON(ImGuiNavInput_Input,      GLFW_GAMEPAD_BUTTON_TRIANGLE);     // Triangle / Y
    MAP_BUTTON(ImGuiNavInput_DpadLeft,   11);    // D-Pad Left
    MAP_BUTTON(ImGuiNavInput_DpadRight,  9);    // D-Pad Right
    MAP_BUTTON(ImGuiNavInput_DpadUp,     8);    // D-Pad Up
